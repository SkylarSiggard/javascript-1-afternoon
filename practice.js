...
function nameCheck(NAMEPARAM) {
  if (NAMEPARAM==='Steven') { return 'What is up Steven?'}
...
function faveColorFinder(favColor) {
  if (favColor==='red') {return 'red is a great color'}
  else if (favColor==='green') {return 'green is a solid favorite color'}
  else if (favColor==='black') {return 'so trendy'}
